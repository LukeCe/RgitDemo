...
3. Create a branch write your code and push the branch to your fork
All this can be done via the git pane in RStudio. 

- click on the git pane (1)
- click new branch and create a name (2 and 3)
- write your code
- commit the changes (4)
- push them to your fork (5)


![](screenshot_branch.png){ width=100% }

To be sure you are no on master you can also use the git pane.

![](screenshot_branch2.png){ width=100% }


4. Regularly check that your fork is up to date with respect to master branch on the upstream repository.


5. Once the feature is ready open a pull request on github inviting the maintainer to copy your branch on merge it into hist master

This has to be done within GitHub
